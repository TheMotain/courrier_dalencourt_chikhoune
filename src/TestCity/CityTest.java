...
public class CityTest {
	...
	public void test_sendLetter(){
		...
		this.city.sendLetter(new PromissoryNote(null, null, new MoneyContent(20)));
	...
	public void test_distributeLetters(){
		...
		Letter<?> letter1 = new PromissoryNote(inhabitant1, inhabitant2, new MoneyContent(20));
		Letter<?> letter2 = new PromissoryNote(inhabitant2, inhabitant3, new MoneyContent(10));
