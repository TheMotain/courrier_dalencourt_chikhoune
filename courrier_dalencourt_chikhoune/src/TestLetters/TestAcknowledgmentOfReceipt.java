...
public class TestAcknowledgmentOfReceipt extends TestSimpleLetter {
	...
	protected Letter<TextContent> getLetter() {
		Letter<TextContent> letter = new AcknowledgmentOfReceipt(this.sender,
				this.receiver, new SimpleLetter(this.receiver, this.sender,
	...
	public void test_getType() {
		Assert.assertEquals(
				"an acknowledgment of receipt which is a simple letter",
				this.letter.getType());
	}

	@Test
	public void test_getMessage() {
		Assert.assertEquals(AcknowledgmentOfReceipt.message
				+ "a simple letter whose content is a text content (Marvel)",
